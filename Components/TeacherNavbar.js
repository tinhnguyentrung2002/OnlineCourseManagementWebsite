          ...
          {userData && (
              <Nav.Item>
                <NavLink
                  ...
                  className="nav-link" 
                >
                 {userData.user_avatar !== "" ? <Image src={userData.user_avatar} roundedCircle width={40} height={40} /> : <Image src={require("../assets/profile.png")} alt="..." roundedCircle width={35} height={35} />} 
