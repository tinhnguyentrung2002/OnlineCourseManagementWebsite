...
// import { getDocs, collection, query, where, arrayRemove, getDoc, doc, updateDoc, deleteDoc, arrayUnion, serverTimestamp, writeBatch} from 'firebase/firestore';
...
//         );
//         const headingsSnapshot = await getDocs(headingsQuery);
//         const headings = [];
